...
const profileStats = spawnSync(process.execPath, ['--experimental-strip-types', '--test', 'tests/profile-stats.test.mjs', 'tests/hosted-gateway.test.mjs'], { cwd: root, env, stdio: 'inherit' });
