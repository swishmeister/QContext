...
const championHabitLabels={unknown:'History pending',first_in_20:'First in 20',one_trick:'One-trick pattern',main:'Main pick',flex:'Flex pick'};
const championHabitRules='Based only on the 20 ranked games before this match: one-trick pattern = 16+ games on this champion; main pick = most-played (ties allowed) with 6+ games; flex pick = 1+ games otherwise; first in 20 = 0 games. Incomplete histories are not classified. These are sample-based habits, not lifetime mastery.';
