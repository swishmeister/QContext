...
type Match = { id:string; startedAt:number; duration:number; win:boolean; champion:string; team:number; participants:Player[]; complete:boolean; allyMean:number|null; enemyMean:number|null; gap:number|null; historiesReady:number; teamRanks?:{allies:RankAverage;enemies:RankAverage} };
